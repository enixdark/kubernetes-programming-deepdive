...
import (
	...
	scheme "github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/client/clientset/versioned/scheme"
...
func newFoos(c *ControllerV1alpha1Client, namespace string) *foos {
	return &foos{
		client: c.RESTClient(),
		ns:     namespace,
	}
