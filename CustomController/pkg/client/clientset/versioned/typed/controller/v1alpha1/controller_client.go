...
import (
	v1alpha1 "github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/apis/controller/v1alpha1"
	"github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/client/clientset/versioned/scheme"
...
// ControllerV1alpha1Client is used to interact with features provided by the controller group.
type ControllerV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ControllerV1alpha1Client) Foos(namespace string) FooInterface {
