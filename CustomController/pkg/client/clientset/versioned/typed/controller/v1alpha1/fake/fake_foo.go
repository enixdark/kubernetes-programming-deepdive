...
var foosResource = schema.GroupVersionResource{Group: "controller", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "controller", Version: "v1alpha1", Kind: "Foo"}
