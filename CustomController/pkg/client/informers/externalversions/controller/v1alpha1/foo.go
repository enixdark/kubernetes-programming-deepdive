...
import (
	...
	controllerv1alpha1 "github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/apis/controller/v1alpha1"
	versioned "github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/client/clientset/versioned"
	internalinterfaces "github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/enixdark/kubernetes-programming-deepdive/CustomController/pkg/client/listers/controller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ControllerV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ControllerV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&controllerv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&controllerv1alpha1.Foo{}, f.defaultInformer)
}
