module github.com/enixdark/kubernetes-programming-deepdive/SampleController

go 1.12

require (
	github.com/enixdark/kubernetes-programming-deepdive/Sample-controller v0.0.0-20190523080124-1130aace4d68
