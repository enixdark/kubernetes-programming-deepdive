...
var foosResource = schema.GroupVersionResource{Group: "samplecontroller", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "samplecontroller", Version: "v1alpha1", Kind: "Foo"}
